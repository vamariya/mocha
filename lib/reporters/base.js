...
function Base(runner) {
  var self = this
    , stats = this.stats = { suites: 0, tests: 0, passes: 0, pending: 0, blocked: 0, dropped: 0, failures: 0 }
...
Base.prototype.epilogue = function(){
  ...
  if(stats.dropped) {
  	fmt = color('dropped', ' ')
		+ color('dropped', ' %d dropped');
	console.log(fmt, stats.dropped);
  }
  //blocked
  if(stats.blocked) {
  	fmt = color('blocked', ' ')
		+ color('blocked', ' %d blocked');
	console.log(fmt, stats.blocked);
   }
